        ...
        <div class="row">
            <div class="col-6 m-auto bg-light">
                <div class="table-responsive">
                    <h3 class="display-4">Turmas</h3> <br>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $turma['escola']?></td>
                                <td><?php echo $turma['status']?></td>

                                <td><a href="editturma.php?id=<?php echo $turma['id'];?>" class="btn btn-warning text-white"><i class="fa-solid fa-pencil"></i></a></td>

                                <td>
                                    <form action="./delete.php" method="POST">
                                        <input type="hidden" name="id" value="<?php echo $turma['id'];?>">
                                        <button  type="submit" class="btn btn-danger text-white" id="btn-delete" onclick = "btnDeletar()" name="btn-delete-turma">
                    ...
                    <br>
                    <a href="./adcturmas.php" class="btn btn-success">Adicionar Turmas</a>
                </div>
            </div>
        </div>
