...
if(isset($_GET['id'])){
    ...
    $professores = mysqli_fetch_array($resultado);  
}
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Professores - Editar</title>
    <!-- Bootstrap CSS -->
                ...
                <form action="./uptade.php" method="POST" class="form-control">
                    ...
                    <div class="input-field col-12">
                        <label for="professor">Nome:
                            <input class="form-control" type="text" value="<?php echo $professores['nome'];?>" name="professor">
                        </label>
                    </div>

                    <div class="input-field col-12">
                        <label for="cpf">CPF:
                            <input class="form-control" type="text"value="<?php echo $professores['cpf'];?>" name="cpf">
                        </label>
                    </div>
                    <a href="./professores.php" class="btn btn-primary mr-5">Voltar</a>
                    <button type="submit" name="btn-editar-prof" class="btn btn-success ml-5 text-white">Atualizar</button>
                </form>
            </div>  
        </div>
    </main>
